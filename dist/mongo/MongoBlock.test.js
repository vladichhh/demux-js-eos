...
const mongoObjectMocks_1 = require("../testHelpers/mongoObjectMocks");
const MongoBlock_1 = require("./MongoBlock");
describe('MongoBlock', () => {
    let mongoBlock;
    beforeEach(() => {
        mongoBlock = new MongoBlock_1.MongoBlock(mongoObjectMocks_1.mongoBlockState, mongoObjectMocks_1.mongoRawActions);
    });
...
//# sourceMappingURL=MongoBlock.test.js.map